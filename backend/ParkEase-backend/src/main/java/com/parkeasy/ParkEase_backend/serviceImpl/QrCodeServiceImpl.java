...
public class QrCodeServiceImpl implements QrCodeService {
	...
	@Override
	public String generateAndUploadQrCode(String email, String ticketNumber, String name, String vehicleNumber,
			String spotLabel, String zone, String startTime, String expirationTime, double price) {
		...
		try {
			...
			String driveUrl = driveService.uploadFileToDrive(localFileName, "ParkEase_QR_" + ticketNumber + ".png");
	...
	@Override
	public File generateQrCodeFile(String email, String ticketNumber, String name, String vehicleNumber,
			String spotLabel, String zone, String startTime, String expirationTime, double price) {

		String localFileName = "qr_email_" + UUID.randomUUID().toString() + ".png";

		try {
			// Build QR data — same format as generateAndUploadQrCode for scanner
			// compatibility
			Map<String, Object> qrData = new LinkedHashMap<>();
			qrData.put("ticket_no", ticketNumber);
			qrData.put("spot", spotLabel + " - " + zone);
